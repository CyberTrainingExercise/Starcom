...
While you were taking control of the DLAB the Yuktobanian soliders activated their satellite based missile system. From now on, if you or any of your team step outside of the DLAB and nearby buildings, you will be shot by enemy missiles.
...
5. Run `python3 satellite.py` on the VM
6. Run the satcom1 FTP server
7. Run the satcom2 VM
8. Run `python3 satellite.py` on the VM
9. Gather IP addresses and add to mission statements
10. Load the onto zip file `zip -e secret_files.zip file1.txt`
11. Put zip file on the USB
12. Verify code is on Laptop with Python/VSCode
13. Verify UI is working
14. Verify Kali laptop is working
15. Verify FTP client can connect
16. Give brief